...
/**
 * <p>
 * 监听TOPIC为：rocketmq-producer 下的TAGS为：tags_async_send_delay 下的消息
 * </p>
 *
 * @author DuXueBo
...
@Slf4j
@Component
@RocketMQMessageListener(consumerGroup = "tagsAsyncSendDelayListener", topic = "rocketmq-producer", selectorExpression = "tags_async_send_delay")
